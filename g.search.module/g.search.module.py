...
def _print_results(data):
    ...
    for item in data:
        print '\n{}'.format(_colorize(item['name'], attrs=['bold']))
...
def _colorize(text, attrs=None, pattern=None):
    ...
    for item in items:
        ...
        for idx in range(len(keywords)):
            ...
            if keyword_found:
                ...
                description = _colorize(description,
                                        attrs=['underline'],
                                        pattern=keyword)
                module_keywords = _colorize(module_keywords,
                                            attrs=['underline'],
                                            pattern=keyword)
